...
module.exports.getAllStations = function (callback, isJSONResponse, params) {
  isJSONResponse = isJSONResponse || false;
  params = params || {};
...
exports.getCurrentTrains = function (callback, isJSONResponse, params) {
  isJSONResponse = isJSONResponse || false;
  params = params || {};
...
exports.getStationData = function (callback, isJSONResponse, params) {
  isJSONResponse = isJSONResponse || false;
  params = params || {};
...
exports.getStationsFilter = function (callback, isJSONResponse, params) {
  isJSONResponse = isJSONResponse || false;
  params = params || {};
...
exports.getTrainMovements = function (callback, isJSONResponse, params) {
  isJSONResponse = isJSONResponse || false;
  params = params || {};
...
exports.getHaconTrains = function (callback, isJSONResponse) {
  isJSONResponse = isJSONResponse || false;
